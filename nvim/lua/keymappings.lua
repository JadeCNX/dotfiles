...
vim.api.nvim_set_keymap('n', '<leader>lp', '<cmd>Lspsaga preview_definition<cr>', opt_noremap_silent)
vim.api.nvim_set_keymap('n', '<leader>lq', '<cmd>Telescope quickfix<cr>', opt_noremap_silent)
...
vim.api.nvim_set_keymap('n', '<leader>/', '<cmd>Telescope live_grep<cr>', opt_noremap_silent)
vim.api.nvim_set_keymap('n', '<leader>?', '<cmd>Telescope live_grep<cr>', opt_noremap_silent)
